...
var Canvas = /** @class */ (function (_super) {
    ...
    Canvas.prototype.renderGroupRow = function (props) {
        ...
        return (react_1.default.createElement(RowGroup_1.default, tslib_1.__assign({}, rowGroupProps, props.row.__metaData, { name: props.row.name, eventBus: this.props.eventBus, renderer: this.props.rowGroupRenderer, renderBaseRow: function (p) { return react_1.default.createElement(Row_1.default, tslib_1.__assign({ ref: ref }, p)); } })));
    };
