...
var HeaderRow = /** @class */ (function (_super) {
    ...
    HeaderRow.prototype.getSortableHeaderCell = function (column) {
        ...
        return (react_1.default.createElement(SortableHeaderCell_1.default, { column: column, rowType: this.props.rowType, onSort: this.props.onSort, sortDirection: sortDirection, sortDescendingFirst: sortDescendingFirst, sortHandlePosition: this.props.sortHandlePosition }));
    };
