...
var CheckboxEditor_1 = tslib_1.__importDefault(require("./common/editors/CheckboxEditor"));
var formatters_1 = require("./formatters");
var rowUtils = tslib_1.__importStar(require("./RowUtils"));
var ColumnUtils_1 = require("./ColumnUtils");
var KeyCodes_1 = tslib_1.__importDefault(require("./KeyCodes"));
...
var ReactDataGrid = /** @class */ (function (_super) {
    ...
    function ReactDataGrid(props) {
        ...
        _this.grid = react_1.default.createRef();
        _this.base = react_1.default.createRef();
        _this.selectAllCheckbox = react_1.default.createRef();
        _this.eventBus = new masks_1.EventBus();
        _this._keysDown = new Set();
        _this.metricsUpdated = function () {
            var columnMetrics = _this.createColumnMetrics();
            if (react_fast_compare_1.default(_this.state.columnMetrics, columnMetrics))
        ...
        _this.handleDragEnter = function (overRowIdx) {
            _this.eventBus.dispatch(enums_1.EventTypes.DRAG_ENTER, overRowIdx);
        };
        ...
        _this.handleCellMouseDown = function (position) {
            _this.eventBus.dispatch(enums_1.EventTypes.SELECT_START, position);
        };
        _this.handleCellMouseEnter = function (position) {
            _this.eventBus.dispatch(enums_1.EventTypes.SELECT_UPDATE, position);
        };
        _this.handleWindowMouseUp = function () {
            _this.eventBus.dispatch(enums_1.EventTypes.SELECT_END);
        };
        ...
        _this.handleDragHandleDoubleClick = function (e) {
            ...
            _this.handleGridRowsUpdated(cellKey, e.rowIdx, _this.props.rowsCount - 1, (_a = {}, _a[cellKey] = e.rowData[cellKey], _a), enums_1.UpdateActions.COLUMN_FILL);
        };
        _this.handleGridRowsUpdated = function (cellKey, fromRow, toRow, updated, action, originRow) {
            ...
            var fromRowData = rowGetter(action === enums_1.UpdateActions.COPY_PASTE ? originRow : fromRow);
        ...
        _this.handleCommit = function (commit) {
            ...
            _this.handleGridRowsUpdated(commit.cellKey, targetRow, targetRow, commit.updated, enums_1.UpdateActions.CELL_UPDATE);
        };
        ...
        _this.handleShiftSelect = function (rowIdx) {
            ...
            if (rowSelection && _this.state.lastRowIdxUiSelected > -1 && _this.isSingleKeyDown(KeyCodes_1.default.Shift)) {
        ...
        _this.handleRowSelect = function (rowIdx, columnKey, rowData, event) {
            ...
            if (_this.useNewRowSelection()) {
                ...
                var selectedRows = _this.props.enableRowSelect === 'single' ? [] : tslib_1.__spread(_this.state.selectedRows);
    ...
    ReactDataGrid.prototype.UNSAFE_componentWillReceiveProps = function (nextProps) {
        if (nextProps.columns && (!ColumnMetrics_1.sameColumns(this.props.columns, nextProps.columns, this.props.columnEquality)
    ...
    ReactDataGrid.prototype.selectCell = function (_a, openEditor) {
        ...
        this.eventBus.dispatch(enums_1.EventTypes.SELECT_CELL, { rowIdx: rowIdx, idx: idx }, openEditor);
    };
    ...
    ReactDataGrid.prototype.getTotalWidth = function () {
        ...
        return ColumnUtils_1.getSize(this.props.columns) * this.props.minColumnWidth;
    };
    ...
    ReactDataGrid.prototype.createColumnMetrics = function (props) {
        ...
        return ColumnMetrics_1.recalculate(metrics);
    };
    ...
    ReactDataGrid.prototype.getHeaderRows = function () {
        ...
        var rows = [{ height: headerRowHeight || rowHeight, rowType: enums_1.HeaderRowType.HEADER }];
        if (this.state.canFilter === true) {
            rows.push({
                rowType: enums_1.HeaderRowType.FILTER,
                filterable: true,
    ...
    ReactDataGrid.prototype.scrollToColumn = function (colIdx) {
        this.eventBus.dispatch(enums_1.EventTypes.SCROLL_TO_COLUMN, colIdx);
    };
    ReactDataGrid.prototype.setupGridColumns = function (props) {
        ...
        if (this.props.rowActionsCell || (props.enableRowSelect && !this.props.rowSelection) || (props.rowSelection && props.rowSelection.showCheckbox !== false)) {
            ...
            var headerRenderer = props.enableRowSelect === 'single'
                ? undefined
                : react_1.default.createElement(SelectAllComponent, { onChange: this.handleCheckboxChange, ref: this.selectAllCheckbox });
            var Formatter = (this.props.rowActionsCell ? this.props.rowActionsCell : CheckboxEditor_1.default);
            var selectColumn = {
                key: 'select-row',
                name: '',
                formatter: react_1.default.createElement(Formatter, { rowSelection: this.props.rowSelection }),
            ...
            this._cachedComputedColumns = Array.isArray(columns)
                ? tslib_1.__spread([selectColumn], columns) : columns.unshift(selectColumn);
        }
        else {
    ...
    ReactDataGrid.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { className: "react-grid-Container", style: { width: containerWidth, minHeight: this.props.minHeight }, ref: this.grid },
            react_1.default.createElement(ToolbarContainer_1.default, { toolbar: this.props.toolbar, columns: this.props.columns, rowsCount: this.props.rowsCount, onToggleFilter: this.handleToggleFilter }),
            react_1.default.createElement(Grid_1.default, { ref: this.base, rowKey: this.props.rowKey, headerRows: this.getHeaderRows(), draggableHeaderCell: this.props.draggableHeaderCell, getValidFilterValues: this.props.getValidFilterValues, columnMetrics: this.state.columnMetrics, rowGetter: this.props.rowGetter, rowsCount: this.props.rowsCount, rowHeight: this.props.rowHeight, rowRenderer: this.props.rowRenderer, rowGroupRenderer: this.props.rowGroupRenderer, cellMetaData: cellMetaData, selectedRows: this.getSelectedRows(), rowSelection: this.getRowSelectionProps(), rowOffsetHeight: this.getRowOffsetHeight(), sortColumn: this.props.sortColumn || this.state.sortColumn, sortDirection: this.props.sortDirection || this.state.sortDirection, onSort: this.handleSort, minHeight: this.props.minHeight, totalWidth: gridWidth, onViewportKeydown: this.handleViewportKeyDown, onViewportKeyup: this.handleViewportKeyUp, onColumnResize: this.handleColumnResize, scrollToRowIndex: this.props.scrollToRowIndex, contextMenu: this.props.contextMenu, enableCellSelect: this.props.enableCellSelect, enableCellAutoFocus: this.props.enableCellAutoFocus, cellNavigationMode: this.props.cellNavigationMode, eventBus: this.eventBus, onScroll: this.props.onScroll, RowsContainer: this.props.RowsContainer, emptyRowsView: this.props.emptyRowsView, onHeaderDrop: this.props.onHeaderDrop, getSubRowDetails: this.props.getSubRowDetails, editorPortalTarget: this.props.editorPortalTarget, interactionMasksMetaData: interactionMasksMetaData, sortHandlePosition: this.props.sortHandlePosition })));
    };
    ...
    ReactDataGrid.defaultProps = {
        ...
        minHeight: 350,
        rowKey: 'id',
        cellNavigationMode: enums_1.CellNavigationMode.NONE,
        enableCellAutoFocus: true,
        minColumnWidth: 80,
        selectAllRenderer: formatters_1.SelectAll,
        columnEquality: ColumnMetrics_1.sameColumn,
        editorPortalTarget: document.body,
        sortHandlePosition: 'after'
    };
