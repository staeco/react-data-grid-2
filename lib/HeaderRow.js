...
var HeaderRow = /** @class */ (function (_super) {
    ...
    HeaderRow.prototype.getSortableHeaderCell = function (column) {
        ...
        return (React.createElement(SortableHeaderCell, { column: column, rowType: this.props.rowType, onSort: this.props.onSort, sortDirection: sortDirection, sortDescendingFirst: sortDescendingFirst, sortHandlePosition: this.props.sortHandlePosition }));
    };
