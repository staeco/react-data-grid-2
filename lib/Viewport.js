...
var Viewport = /** @class */ (function (_super) {
    ...
    Viewport.prototype.updateScroll = function (scrollParams) {
        ...
        var prevScrollState = pick(this.state, Object.keys(nextScrollState));
        if (deepEqual(prevScrollState, nextScrollState))
            return; // nothing changed
        this.setState(nextScrollState);
        return nextScrollState;
    };
    Viewport.prototype.UNSAFE_componentWillReceiveProps = function (nextProps) {
