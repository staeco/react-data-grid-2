...
var Header = /** @class */ (function (_super) {
    ...
    function Header() {
        ...
        _this.onColumnResize = function (column, width) {
            ...
            var columnMetrics = resizeColumn(tslib_1.__assign({}, prevColumnMetrics), pos, width);
    ...
    Header.prototype.UNSAFE_componentWillReceiveProps = function () {
