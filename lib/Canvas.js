...
var Canvas = /** @class */ (function (_super) {
    ...
    Canvas.prototype.renderGroupRow = function (props) {
        var ref = props.ref, rowGroupProps = __rest(props, ["ref"]);
        return (React.createElement(RowGroup, __assign({}, rowGroupProps, props.row.__metaData, { name: props.row.name, eventBus: this.props.eventBus, renderer: this.props.rowGroupRenderer, renderBaseRow: function (p) { return React.createElement(Row, __assign({ ref: ref }, p)); } })));
    };
