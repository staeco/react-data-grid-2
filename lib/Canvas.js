...
var Canvas = /** @class */ (function (_super) {
    ...
    Canvas.prototype.UNSAFE_componentDidUpdate = function (prevProps) {
    ...
    Canvas.prototype.scrollToColumn = function (idx) {
        ...
        var newScrollLeft = getColumnScrollPosition(this.props.columns, idx, scrollLeft, clientWidth);
        if (newScrollLeft !== 0) {
    ...
    Canvas.prototype.renderCustomRowRenderer = function (props) {
        ...
        var customRowRendererProps = tslib_1.__assign({}, otherProps, { renderBaseRow: function (p) { return React.createElement(Row, tslib_1.__assign({ ref: ref }, p)); } });
        if (isElement(CustomRowRenderer)) {
            if (CustomRowRenderer.type === Row) {
                ...
                return React.createElement(Row, tslib_1.__assign({}, props));
            }
    ...
    Canvas.prototype.renderGroupRow = function (props) {
        ...
        return (React.createElement(RowGroup, tslib_1.__assign({}, rowGroupProps, props.row.__metaData, { name: props.row.name, eventBus: this.props.eventBus, renderer: this.props.rowGroupRenderer, renderBaseRow: function (p) { return React.createElement(Row, tslib_1.__assign({ ref: ref }, p)); } })));
    };
