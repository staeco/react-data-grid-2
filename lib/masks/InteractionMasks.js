...
import { getSelectedDimensions, getSelectedCellValue, getSelectedRow, getSelectedRangeDimensions, getSelectedColumn, getNextSelectedCellPosition, canExitGrid, isSelectedCellEditable, selectedRangeIsSingleCell } from '../utils/SelectedCellUtils';
...
var InteractionMasks = /** @class */ (function (_super) {
    ...
    function InteractionMasks() {
        ...
        _this.handleDragEnd = function () {
            ...
            var column = getSelectedColumn({ selectedPosition: draggedPosition, columns: columns });
        ...
        _this.onDragHandleDoubleClick = function () {
            ...
            var rowData = getSelectedRow({ selectedPosition: selectedPosition, rowGetter: rowGetter });
    ...
    InteractionMasks.prototype.UNSAFE_componentDidUpdate = function (prevProps, prevState) {
    ...
    InteractionMasks.prototype.handlePaste = function () {
        ...
        var cellKey = getSelectedColumn({ selectedPosition: selectedPosition, columns: columns }).key;
    ...
    InteractionMasks.prototype.renderCellRangeSelectView = function () {
        ...
        return (React.createElement(React.Fragment, null,
            React.createElement(SelectionRangeMask, tslib_1.__assign({}, getSelectedRangeDimensions({ selectedRange: this.state.selectedRange, columns: columns, rowHeight: rowHeight }))),
            React.createElement(SelectionMask, tslib_1.__assign({}, this.getSelectedDimensions(this.state.selectedPosition, true), { ref: this.selectionMask }))));
    };
    InteractionMasks.prototype.render = function () {
        ...
        return (React.createElement("div", { onKeyDown: this.onKeyDown, onFocus: this.onFocus },
            copiedPosition && (React.createElement(CopyMask, tslib_1.__assign({}, this.getSelectedDimensions(copiedPosition), { ref: this.copyMask }))),
            ...
            isEditorEnabled && (React.createElement(EditorPortal, { target: this.props.editorPortalTarget },
                React.createElement(EditorContainer, tslib_1.__assign({ firstEditorKeyPress: firstEditorKeyPress, onCommit: this.onCommit, onCommitCancel: this.onCommitCancel, rowIdx: selectedPosition.rowIdx, value: getSelectedCellValue({ selectedPosition: selectedPosition, columns: columns, rowGetter: rowGetter }), rowData: rowData, column: getSelectedColumn({ selectedPosition: selectedPosition, columns: columns }), scrollLeft: scrollLeft, scrollTop: scrollTop }, this.getSelectedDimensions(selectedPosition), this.state.editorPosition)))),
            isElement(contextMenu) && cloneElement(contextMenu, tslib_1.__assign({}, selectedPosition))));
    };
