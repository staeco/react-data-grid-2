...
var ReactDataGrid = /** @class */ (function (_super) {
    ...
    function ReactDataGrid(props) {
        ...
        _this.metricsUpdated = function () {
            ...
            if (deepEqual(_this.state.columnMetrics, columnMetrics))
        ...
        _this._debounced = debounce(_this.metricsUpdated.bind(_this), 250);
        var initialState = {
    ...
    ReactDataGrid.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "react-grid-Container", style: { width: containerWidth, minHeight: this.props.minHeight }, ref: this.grid },
