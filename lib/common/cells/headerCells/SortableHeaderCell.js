...
var SORT_TEXT = (_a = {},
    _a[DEFINE_SORT.ASC] = function () { return React.createElement(FaCaretDown, { size: 18 }); },
    _a[DEFINE_SORT.DESC] = function () { return React.createElement(FaCaretUp, { size: 18 }); },
    _a[DEFINE_SORT.NONE] = function () { return null; },
    _a);
export default function SortableHeaderCell(props) {
    ...
    var sortArrow = React.createElement("span", { className: "pull-right" }, icon());
