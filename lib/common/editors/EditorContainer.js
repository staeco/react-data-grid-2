...
var EditorContainer = /** @class */ (function (_super) {
    ...
    function EditorContainer() {
        ...
        _this.isNewValueValid = function (value) {
            var validate = _this.getEditor().validate;
            if (validate) {
    ...
    EditorContainer.prototype.UNSAFE_componentDidUpdate = function (prevProps) {
    ...
    EditorContainer.prototype.createEditor = function () {
        ...
        if (isValidElementType(CustomEditor)) {
            return React.createElement(CustomEditor, tslib_1.__assign({}, editorProps));
        }
